...
#warning You have to replace the site ID, timezone & OAuth2 token with one generated by the WP.com API
        oauth2Token = nil;
        siteId = nil;
        oauth2Token = @"cqi5Cbgie)E@p20veB)x6w^jv9p(s%D*FN0%b^Bi@aTaxJpwC8j29A(znBmNXtHS";
        siteId = @66592863; // astralbodi.es
//        siteId = @54117; // automattic.com
//        siteId = @489937;
//        siteId = @79396439; // MarilynSchmidGallery
//        siteId = @55605385; // Maple Bacon Yummies (1st test)
