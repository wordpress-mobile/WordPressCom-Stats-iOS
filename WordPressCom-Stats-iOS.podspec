Pod::Spec.new do |s|
  ...
  s.subspec 'UI' do |sp|
    ...
    sp.resource_bundle = { 'WordPressCom-Stats-iOS' => ['WordPressCom-Stats-iOS/Resources/*.storyboard', 'WordPressCom-Stats-iOS/Resources/*.xib', 'WordPressCom-Stats-iOS/Resources/*.otf', 'WordPressCom-Stats-iOS/Resources/*.png'] }
  end
