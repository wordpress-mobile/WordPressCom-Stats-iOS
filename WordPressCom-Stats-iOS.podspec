Pod::Spec.new do |s|
  ...
  s.resource_bundle = { 'WordPressCom-Stats-iOS' => ['WordPressCom-Stats-iOS/*.storyboard', 'WordPressCom-Stats-iOS/*.xib', 'WordPressCom-Stats-iOS/*.otf', 'WordPressCom-Stats-iOS/Images.xcassets'] }
  s.requires_arc = true
