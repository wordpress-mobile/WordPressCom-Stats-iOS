...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _titleLabel.font = [WPStatsStyleGuide tableviewSectionHeaderFont];
        _titleLabel.textColor = [WPStatsStyleGuide whisperGrey];
...
+ (CGSize)sizeForTitle:(NSString *)title andWidth:(CGFloat)width
{
    ...
    return [title suggestedSizeWithFont:[WPStatsStyleGuide tableviewSectionHeaderFont] width:titleWidth];
}
